...
public class SystemComplexity extends MetricBase implements MetricInterface {
	...
	public void runMetric(Object... params) {
		...
		// System.out.println(metricName+" will not run. Requirements not
		// met.");
		// //Kill here
	...
	public double calculateAccuracy(MetricResult mr, String resType1, String resType2, double thresholdT1,
			double thresholdT2) {
		...
		// System.out.println(String.format("Results Type 1: %1$s Results Type
		// 2: %2$s. Threshold1: %3$f. Threshold2: %4$f",
		...
		double acc = hits / (double) numberOfRealInstances; // This is basically
															// the true positive
															// accuracy
		...
		return perc;
		// return
		// (double)theResult.getGoodHits()/(double)theResult.getTotalHits();
