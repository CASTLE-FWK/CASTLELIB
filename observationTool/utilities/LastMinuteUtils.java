...
//		System.out.println(s);
		...
		String s = buildExperimentFile("/home/lachlan/repos/repastModels/runtime/output/ac/list.txt", "/home/lachlan/repos/repastModels/AntColony/AntColony/experiments/metrics.json");
		System.out.println(s);
	}
	...
	public static String buildExperimentFile(String pathsTXT, String pathToMetricsJSON) {
		List<String> paths = new List<String>(Utilities.parseFileLineXLine(pathsTXT));
		String out = "{\n" +
		        "\"Experiment-id\": \"Baseline-Strong\",\n"+
		        "\"Description\": \"Baseline-Strong\",\n"+
		        "\"System-name\": \"AntColony\",\n"; 
		out += "\"Test-Systems\": [\n";
		...
		for (int i = 0; i < paths.size(); i++) {
			...
			if (s.startsWith("#")) {
				...
				out += templateString.replace(COUNTNAME,""+count).replace(CONFNAME, currConfName).replace(PATHREP,s);
				if (i == paths.size()-1) {
					out += "\n";
				} else {
					out += ",\n";
