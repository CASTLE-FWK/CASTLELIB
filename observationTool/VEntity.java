...
//		parameters = new HashMap<String, Parameter<?>>(newV.getParameters());
	...
	public void addParameterFromString(String name, String type, String value) {
		if (name.compareToIgnoreCase("Position") == 0 || name.compareToIgnoreCase("Location") == 0 || name.compareToIgnoreCase("birdPosition") == 0 || name.compareToIgnoreCase("cellPosition") == 0) {
